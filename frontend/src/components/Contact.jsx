...
export default function Contact() {
  ...
  return (
    <section id="contact" className="bg-gray-50 py-20 dark:bg-brand-green-900 sm:py-28">
        ...
        <div className="mt-14 grid grid-cols-1 gap-8 lg:grid-cols-5">
          <div className="space-y-4 lg:col-span-2">
            <a
              ...
              className="card flex items-center gap-4 p-5 hover:border-brand-green-300"
            >
              <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-brand-green-700 text-brand-yellow-400">
                <Phone className="h-5 w-5" />
              </span>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-400">Call Us</p>
                <p className="text-lg font-bold text-brand-green-800 dark:text-white">
            ...
            >
              ...
              <div>
                ...
                <p className="text-lg font-bold text-brand-green-800 dark:text-white">Message Us Instantly</p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <p className="text-lg font-bold text-brand-green-800 dark:text-white">{siteConfig.email}</p>
              </div>
            </a>
            ...
            <div className="card flex items-center gap-4 p-5">
              ...
              <div>
                ...
                <p className="text-base font-semibold text-brand-green-800 dark:text-white">
                  {siteConfig.address}
                </p>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="card space-y-4 p-6 lg:col-span-3 sm:p-8">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="mt-1 w-full rounded-lg border border-gray-200 px-4 py-2.5 text-sm focus:border-brand-green-500 focus:outline-none focus:ring-2 focus:ring-brand-green-200 dark:border-white/10 dark:bg-brand-green-800/40 dark:text-white"
            ...
            {status === 'success' && (
              <p className="flex items-center gap-2 text-sm font-medium text-brand-green-600">
